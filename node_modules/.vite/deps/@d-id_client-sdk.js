...
var ve = (e, t, n) => t in e ? ye(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
...
var Re = ((e) => (e.TRIAL = "trial", e.BASIC = "basic", e.ENTERPRISE = "enterprise", e.LITE = "lite", e.ADVANCED = "advanced", e))(Re || {});
var Se = ((e) => (e.TRIAL = "deid-trial", e.PRO = "deid-pro", e.ENTERPRISE = "deid-enterprise", e.LITE = "deid-lite", e.ADVANCED = "deid-advanced", e.BUILD = "deid-api-build", e.LAUNCH = "deid-api-launch", e.SCALE = "deid-api-scale", e))(Se || {});
var Ie = ((e) => (e.Created = "created", e.Started = "started", e.Done = "done", e.Error = "error", e.Rejected = "rejected", e.Ready = "ready", e))(Ie || {});
var Ee = ((e) => (e.Unrated = "Unrated", e.Positive = "Positive", e.Negative = "Negative", e))(Ee || {});
var M = ((e) => (e.Functional = "Functional", e.TextOnly = "TextOnly", e.Maintenance = "Maintenance", e.Playground = "Playground", e.DirectPlayback = "DirectPlayback", e.Off = "Off", e))(M || {});
var q = ((e) => (e.Embed = "embed", e.Query = "query", e.Partial = "partial", e.Answer = "answer", e.Complete = "done", e))(q || {});
var Me = ((e) => (e.KnowledgeProcessing = "knowledge/processing", e.KnowledgeIndexing = "knowledge/indexing", e.KnowledgeFailed = "knowledge/error", e.KnowledgeDone = "knowledge/done", e))(Me || {});
var _e = ((e) => (e.Knowledge = "knowledge", e.Document = "document", e.Record = "record", e))(_e || {});
var Te = ((e) => (e.Pdf = "pdf", e.Text = "text", e.Html = "html", e.Word = "word", e.Json = "json", e.Markdown = "markdown", e.Csv = "csv", e.Excel = "excel", e.Powerpoint = "powerpoint", e.Archive = "archive", e.Image = "image", e.Audio = "audio", e.Video = "video", e))(Te || {});
var je = ((e) => (e.Clip = "clip", e.Talk = "talk", e))(je || {});
var It = (e) => {
  switch (e) {
    case "clip":
      return "clip";
...
var h = ((e) => (e.Start = "START", e.Stop = "STOP", e))(h || {});
var Q = ((e) => (e.Strong = "STRONG", e.Weak = "WEAK", e.Unknown = "UNKNOWN", e))(Q || {});
var O = ((e) => (e.Idle = "IDLE", e.Talking = "TALKING", e))(O || {});
var A = ((e) => (e.ChatAnswer = "chat/answer", e.ChatPartial = "chat/partial", e.StreamDone = "stream/done", e.StreamStarted = "stream/started", e.StreamFailed = "stream/error", e.StreamReady = "stream/ready", e.StreamCreated = "stream/created", e.StreamInterrupt = "stream/interrupt", e.StreamVideoCreated = "stream-video/started", e.StreamVideoDone = "stream-video/done", e.StreamVideoError = "stream-video/error", e.StreamVideoRejected = "stream-video/rejected", e))(A || {});
var I = ((e) => (e.New = "new", e.Fail = "fail", e.Connected = "connected", e.Connecting = "connecting", e.Closed = "closed", e.Completed = "completed", e.Disconnected = "disconnected", e))(I || {});
var W = ((e) => (e.Legacy = "legacy", e.Fluent = "fluent", e))(W || {});
var Pe = ((e) => (e.Amazon = "amazon", e.Microsoft = "microsoft", e.Afflorithmics = "afflorithmics", e.Elevenlabs = "elevenlabs", e))(Pe || {});
var be = ((e) => (e.Public = "public", e.Premium = "premium", e.Private = "private", e))(be || {});
var Ae = 45 * 1e3;
var Be = "X-Playground-Chat";
var Z = "https://api.d-id.com";
var Le = "wss://notifications.d-id.com";
var $e = "79f81a83a67430be2bc0fd61042b8faa";
var oe = (e) => new Promise((t) => setTimeout(t, e));
var V = (e = 16) => {
  const t = new Uint8Array(e);
  return window.crypto.getRandomValues(t), Array.from(t, (n) => n.toString(16).padStart(2, "0")).join("").slice(0, 13);
};
var ze = (e) => [M.TextOnly, M.Playground, M.Maintenance].includes(e);
var ce = (e) => e && [M.DirectPlayback, M.Off].includes(e);
function Fe(e, t) {
  let n;
  return {
...
var me = (e) => e.type === "clip" && e.presenter_id.startsWith("v2_") ? "clip_v2" : e.type;
function Je(e) {
  var s, o, c, a;
...
var Ue = (e) => e.reduce((t, n) => t + n, 0);
var ae = (e) => Ue(e) / e.length;
function Ke(e, t, n) {
  var i, d, l;
  const {
    event: r,
...
var ee = {};
var He = "https://api-js.mixpanel.com/track/?verbose=1&ip=1";
function qe(e) {
...
async function we(e, t, n, r, s = false, o) {
  try {
...
var ne = 100;
var ot = Math.max(Math.ceil(400 / ne), 1);
var ct = 0.25;
var dt = 0.28;
function lt() {
  let e = 0, t, n, r = 0;
...
function ut(e, t, n, r, s, o = false) {
  let c = [], a, i = 0, d = false, l = Q.Unknown, y = Q.Unknown, _ = 0, T = 0;
  const j = lt();
  return setInterval(async () => {
    ...
    if (R)
      i = 0, _ = K - T, y = U < ct ? Q.Strong : U > dt && _ > 1 ? Q.Weak : l, y !== l && (s == null || s(y), l = y, T += _, _ = 0), d || (r == null || r(h.Start), a = c[c.length - 1], c = [], d = true), c.push(P);
    else if (d && (i++, i >= ot)) {
      const u = st(c, ne, a);
      r == null || r(h.Stop, u), t() || n(), T = K, d = false;
    }
  }, ne);
}
var pe = false;
var B = (e, t) => pe && console.log(e, t);
var ft = (window.RTCPeerConnection || window.webkitRTCPeerConnection || window.mozRTCPeerConnection).bind(window);
function ie(e) {
  switch (e) {
    case "connected":
      return I.Connected;
...
async function wt(e, t, {
  ...
  var J;
  pe = n;
  let a = false, i = false, d = h.Stop, l = h.Stop;
  const {
    startConnection: y,
    sendStreamRequest: _,
    close: T,
  ...
  const p = t.stream_warmup && !u, b = () => a, L = () => {
    var f;
    a = true, i && ((f = r.onConnectionStateChange) == null || f.call(r, I.Connected));
  }, $ = ut(m, b, L, (f, g) => se({
    statsSignal: l = f,
...
async function Et(e, t) {
  ...
  async function j(u) {
    ...
    p && p.id !== ((E = a.chat) == null ? void 0 : E.id) && ((z = (C = t.callbacks).onNewChat) == null || z.call(C, p.id)), a.streamingManager = w, a.socketManager = D, a.chat = p, n = false, i.enrich({
  ...
  return {
    ...
    getIsInterruptAvailable: () => {
      var u;
      return ((u = a.streamingManager) == null ? void 0 : u.interruptAvailable) ?? false;
    },
    ...
    async connect() {
      await j(true), i.track("agent-chat", {
        event: "connect",
        mode: a.chatMode
      });
    },
    async reconnect() {
      await x(), await j(false), i.track("agent-chat", {
        event: "reconnect",
        mode: a.chatMode
      });
    },
    ...
    async chat(u) {
      ...
      const v = () => {
        ...
        shouldRetryFn: (C) => {
          ...
          return !((f = C == null ? void 0 : C.message) == null ? void 0 : f.includes("Stream Error")) && !z ? ((S = (g = t.callbacks).onError) == null || S.call(g, C), false) : true;
        },
        onRetry: async () => {
          await x(), await j(false);
        }
      });
      try {
        _(), v(), a.messages.push({
    ...
    async speak(u) {
      ...
      if (i.track("agent-speak", m), N.update(), a.messages && m.type === "text" && (a.messages.push({
        ...
        role: "assistant",
        content: m.input,
        created_at: new Date(N.get(true)).toISOString()
    ...
    async interrupt({
      ...
      i.track("agent-video-interrupt", {
        type: u || "click",
        video_duration_to_interrupt: re.get(true),
        message_duration_to_interrupt: N.get(true)
      }), v.interrupted = true, (w = (D = t.callbacks).onNewMessage) == null || w.call(D, [...a.messages], "answer"), Xe(a.streamingManager, r);
    }
  };
}
function Mt(e, t, n) {
